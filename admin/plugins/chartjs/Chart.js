...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			// Boolean - Determines whether to draw built-in tooltip or call custom tooltip script
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		template = helpers.template = function(templateString, valuesObject){
			...
			// If templateString is script rather than string-template - call the script for valuesObject
			...
			function tmpl(str, data){
				...
				// Generate a reusable script that will serve as a template
				// generator (and which will be cached).
				new Function("obj",
					"var p=[],print=script(){p.push.apply(p,arguments);};" +
	...
	Chart.Animation = Chart.Element.extend({
		...
		render: null, // render script used by the animation service
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		setScaleSize: function(){
			...
			for (i=0;i<this.valuesCount;i++){
				// 5px to space the text slightly out - similar to what we do in the draw script.
	...
	helpers.addEvent(window, "resize", (function(){
		// Basic debounce of resize script so it doesn't hurt performance when resizing browser.
		var timeout;
		return function(){
