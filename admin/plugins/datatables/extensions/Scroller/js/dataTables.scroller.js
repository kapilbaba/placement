...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 * all of the records into a finite area, but this script returns a linear
	...
	"_fnConstruct": function ()
	{
		 ...
		 * script for the save save callback so we aren't hitting it on every
		 * scroll
		 */
	...
	/**
	 * Scrolling script - fired whenever the scrolling position is changed.
	...
	/**
	 * Draw callback script which is fired when the DataTable is redrawn. The main script of
	 ...
	 * viewport and what rows are visible in it. This script basically acts in the same way as
	 * _fnUpdateInfo in DataTables, and effectively replaces that script.
	 *  @returns {void}
	 *  @private
	 */
	"_fnInfo": function ()
