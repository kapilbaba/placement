...
AutoFill.defaults = {
	...
	column: {
		 ...
		 * Cell read script
		 *
		 * Default script will simply read the value from the HTML of the
		 * cell.
		 *
		 * @type   {function}
		 ...
		 * Cell write script
		 *
		 * Default script will simply write to the HTML and tell the DataTable
		 * to update.
		 *
		 * @type   {function}
		...
		/**
		 * Step script. This provides the ability to customise how the values
		 * are incremented.
		 *
		 * @param  {node} cell `th` / `td` element that is being operated upon
		 * @param  {string} read Cell value from `read` script
