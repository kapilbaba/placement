...
var ZeroClipboard_TableTools = {
	...
	$: function(thingy) {
		// simple DOM lookup utility script
	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				// bug fix: Cannot extend EMBED DOM elements in Firefox, must use traditional script
 ...
 * @param {Function} oOpts.fnPreRowSelect Callback script just prior to row selection
 * @param {Function} oOpts.fnRowSelected Callback script just after row selection
 * @param {Function} oOpts.fnRowDeselected Callback script when row is deselected
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		"print": {
			...
			/** 
			 * Wrapped script to end the print display (to maintain scope)
			 *  @property funcEnd
			 *  @type	 Function
			 *  @default  script () {}
			 */
...
TableTools.prototype = {
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$(dt.nTBody).on( 'click.DTTT_Select', this.s.custom.sRowSelector, function(e) {
				...
				select.lastRow = pos;
			} );//.on('selectstart', script () { return false; } );
	...
	"_fnRowSelect": function ( src, e )
	{
		...
		// User defined pre-selection script
	...
	"_fnTextConfig": function ( nButton, oConfig )
	{
		...
		$(nButton).click( function (e) {
			...
			/* Provide a complete script to match the behaviour of the flash elements */
	...
	/**
	 * Wait until the id is in the DOM before we "glue" the swf. Note that this script will call
	 ...
	 * 
	 * This script is required for large information sets. There is a limit on the
	...
	/**
	 * Hide nodes which are not needed in order to display the table. Note that this script is
	 * recursive
 ...
 *  @param   {Object} that Scope of the listening script (i.e. 'this' in the caller)
...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Print view</h6><p>Please use your browser's print script to "+
