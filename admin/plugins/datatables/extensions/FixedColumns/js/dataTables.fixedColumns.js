...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 * perform this script automatically when the window.resize event is fired.
	 *  @returns {void}
	 *  @example
	 *      var table = $('#example').dataTable( {
	 *          "scrollX": "100%"
	 ...
	 * height matching. This script will have no effect when 'none' or 'auto' row height
	 * matching is used.
	...
	/**
	 * Get data index.php information about a row or cell in the table body.
	 * This script is functionally identical to fnGetPosition in DataTables,
	 * taking the same parameter (TH, TD or TR node) and returning exactly the
	 * the same information (data index.php information). THe difference between
	 * the two is that this method takes into account the fixed columns in the
	 * table, so you can pass in nodes from the master table, or the cloned
	 * tables and get the index.php position for the data in the main table.
	 *  @param {node} node TR, TH or TD element to get the information about
	 *  @returns {int} If nNode is given as a TR, then a single index.php is
	 *    returned, or if given as a cell, an array of [row index.php, column index.php
	 *    (visible), column index.php (all)] is given.
	 */
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( bAll )
		{
			...
			/* Use the handy _fnDrawHead script in DataTables to do the rowspan/colspan
			 * calculations for us
			 */
...
FixedColumns.defaults = /** @lends FixedColumns.defaults */{
	...
	/**
	 * Draw callback script which is called when FixedColumns has redrawn the fixed assets
	 *  @type     script(object, object):void
	 *  @default  null
	 *  @static
	 *  @example
	 *      var table = $('#example').dataTable( {
